...
# These variables don't differentiate the samples
Var_500_RPKM_pca_sort <- PCAtools::biplot(Var_500_RPKM_pca, colby = "Sort_short", colLegendTitle = "Cell Population", legendPosition = 'right')
Var_500_RPKM_pca_Donor <- PCAtools::biplot(Var_500_RPKM_pca, colby = "Donor_ID", colLegendTitle = "Donor", legendPosition = 'right')
Var_500_RPKM_pca_time <- PCAtools::biplot(Var_500_RPKM_pca, colby = "Timepoint", colLegendTitle = "Timepoint", legendPosition = 'right')

pcas_comb <- ggarrange(Var_500_RPKM_pca_sort ,
                       Var_500_RPKM_pca_Donor,
                       Var_500_RPKM_pca_time, nrow = 2, ncol = 2 )

ggsave(pcas_comb, file = file.path(plotDir, "Var_500_RPKM_pcas.pdf"), device = "pdf", height = 15, width = 15)
