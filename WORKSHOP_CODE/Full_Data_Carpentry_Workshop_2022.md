...
```
    ...
    ## Old packages: 'ade4', 'bbmle', 'bdsmatrix', 'bigmemory', 'bigtabulate',
    ##   'BiocManager', 'blob', 'broom', 'Cairo', 'car', 'caret', 'checkmate',
    ##   'circlize', 'cli', 'clue', 'cluster', 'commonmark', 'conquer', 'crayon',
    ##   'dbplyr', 'desc', 'deSolve', 'dplyr', 'DT', 'e1071', 'ellipse', 'fansi',
    ##   'fda', 'fitdistrplus', 'FNN', 'formatR', 'furrr', 'future', 'future.apply',
    ##   'gdata', 'gert', 'ggplot2', 'ggpmisc', 'ggpp', 'glmnet', 'globals',
    ##   'gmodels', 'gplots', 'gt', 'gtools', 'hardhat', 'haven', 'Hmisc', 'httr',
    ##   'ICC', 'igraph', 'ipred', 'kernlab', 'knitr', 'ks', 'leaflet', 'leiden',
    ##   'leidenbase', 'limma', 'lme4', 'lmtest', 'locfit', 'magrittr', 'maptools',
    ##   'MASS', 'Matching', 'Matrix', 'matrixStats', 'mclust', 'mgcv', 'mnormt',
    ##   'mongolite', 'nlme', 'nloptr', 'openssl', 'parallelly', 'pbmcapply', 'pcaPP',
    ##   'plyr', 'polynom', 'processx', 'progressr', 'proxy', 'ps', 'quantreg',
    ##   'randomForest', 'RColorBrewer', 'Rcpp', 'RcppArmadillo', 'RcppEigen',
    ##   'RCurl', 'readxl', 'reshape', 'restfulr', 'reticulate', 'rgdal', 'rhdf5',
    ##   'rlang', 'rly', 'rmarkdown', 'roxygen2', 'rprojroot', 'rrcov', 'RSpectra',
    ##   'RSQLite', 'Rtsne', 'S4Vectors', 'sass', 'scales', 'Seurat', 'SeuratObject',
    ##   'sf', 'sp', 'spatstat.core', 'spatstat.data', 'spatstat.geom',
    ##   'spatstat.random', 'spatstat.sparse', 'spatstat.utils', 'spdep', 'terra',
    ##   'testthat', 'tibble', 'tinytex', 'tzdb', 'umap', 'usethis', 'uuid', 'V8',
    ##   'vctrs', 'vegan', 'VennDiagram', 'waldo', 'webshot', 'WGCNA', 'withr',
    ##   'xfun', 'zoo'
